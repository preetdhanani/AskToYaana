...
# GROQ_API_KEY = "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"

# llm = ChatGroq(api_key=GROQ_API_KEY, model_name='llama-3.2-90b-text-preview')
# pre_prompt = """
#                 you are a beauty expert, suggest advice to user based on skin problem with three to four beauty products with description, 
